...
class OphCiPatientdischargeModule extends BaseEventTypeModule
{
	...
	public function init()
	{
		...
		$this->setImport(array(
			'OphCiPatientdischarge.models.*',
			'OphCiPatientdischarge.components.*',
		));

		$this->moduleShortSuffix = "patientdischarge";
	}
