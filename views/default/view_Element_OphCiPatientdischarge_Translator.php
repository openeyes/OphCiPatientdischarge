...
?>
	<div class="element-data">
		...
		<div class="row data-row">
			...
			<div class="large-9 column end"><div class="data-value"><?php echo $element->caregiver_present ? $element->caregiver_present->name : 'Not recorded'?></div></div>
		</div>
		<?php if ($element->caregiver_present && $element->caregiver_present->name == 'Yes') {?>
			...
			<div class="row data-row">
				...
				<div class="large-9 column end"><div class="data-value"><?php echo CHtml::encode($element->caregiver_relationship->name)?></div></div>
			</div>
		<?php }?>
	</div>
